...
<head>
    ...
    <link rel="stylesheet" href="/css/2013-07.css">
</head>
<body>

<div class="pure-g-r content rx-layout">
    <div class="pure-u rx-nav">
        ...
        <div class="nav-inner">
            ...
            <div class="pure-menu pure-menu-open">
                <ul>
                    <li class="pure-menu-heading">ranx.us</li>
				    <li><a href="/game/new">New Game</a></li>
				    <li><a href="/ladders">View Ladders</a></li>
